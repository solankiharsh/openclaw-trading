...
try {
  ...
  if (!verifyRes.ok) {
    ...
    console.log(`   Full response:`, verifyData);
    process.exit(1);
  }
  ...
  console.log('  2. ✅ Get SIWS challenge');
  console.log('  3. ✅ Sign message');
  console.log('  4. ✅ Verify signature → JWT');
  console.log('  5. ✅ Access authenticated endpoint');
  console.log('  6. ✅ Onboarding tasks created');
  console.log('');
  console.log('🎉 All steps working!\n');
